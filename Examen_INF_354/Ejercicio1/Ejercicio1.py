...
class Neurona:
  ...
  def retroalimentacion(self, inputs):
    # Producto punto # multiplicación de todas las entradas con pesos
    # x1*y1 + x2*y2 + ...
...
class redNeuronaal:
  ...
  def __init__(self):
    ...
    self.neurona1 = Neurona(pesos, bias) # y1
    self.neurona2 = Neurona(pesos, bias) # y2
    self.neurona3 = Neurona(pesos, bias) # y3

  def retroalimentacion(self, x):
    salida_neurona1 = self.neurona1.retroalimentacion(x) # Entrada
    salida_neurona2 = self.neurona2.retroalimentacion(x) # Entrada

    salida_neurona3 = self.neurona3.retroalimentacion(np.array([salida_neurona1, salida_neurona2])) # Entrada de y1, y2
...
print(mse_perdida(y_true, y_pred))  # 50% esta bien clasificado
#----------------------------------------------------
# Modificar
